...
- **Messages are end-to-end encrypted** - we cannot read them, and that's by design
- **You sign up with a username**, not a phone number (adding one is optional and always under your control)
- **Groups are invite-only** - no public directories, no scraping, no strangers
- **Your data lives in the EU** - and we tell you exactly where and for how long
- **The web app is free** - supported by donations and optional paid mobile apps, not your attention
...
The project is in its early days. If you want to follow along:

- A proper website and mailing list are coming - until then, the GitHub (Gitlab in the future) is the source of truth

---

<sub>Built with care in the EU · No tracking on this page · AGPLv3 planned for client code</sub>
